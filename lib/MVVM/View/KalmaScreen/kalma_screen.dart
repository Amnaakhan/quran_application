...
import 'package:quran_application/MVVM/View/KalmaScreen/kalma_detail.dart';
...
import '../../body_model/kalma_detail_list.dart';
...
body: Column(
  children: [ Stack(
    ...
    SizedBox(height: 3.h),
    Expanded(child: _buildListKamaView())

  ],
),
    );
  }
  Widget _buildListKamaView() {



      return ListView.builder(
        padding: EdgeInsets.zero,
        itemCount: kalimaList.length,
        itemBuilder: (context, index) {
          final kalima = kalimaList[index];
          return
            InkWell(
              onTap: (){
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => KalimaDetailScreen(kalima: kalima),
                  ),
                );
              },
              child: Padding(
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        SizedBox(width: 3.w,),
                        Text('${kalima.title}',style: TextStyles.surahtext,),
                        Spacer(),
                        Text('(${kalima.arabicTitle})',style: TextStyles.surahtext,),
